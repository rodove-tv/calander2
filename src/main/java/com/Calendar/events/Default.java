...
public class Default extends Events {
    ...
    public Default(String eventName, String eventOwner, int year, int month, int day, int hourOfDay, int minuteOfDay, LocalDateTime date, String location, String description, com.Calendar.users.User user) {
